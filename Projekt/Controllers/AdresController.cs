...
namespace Projekt.Controllers
{
    ...
    public class AdresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,miasto,kod,ulica,numer")] Adres adres)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,miasto,kod,ulica,numer")] Adres adres)
        {
            if (ModelState.IsValid)
            {
